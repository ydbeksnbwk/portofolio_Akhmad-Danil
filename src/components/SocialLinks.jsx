...
const socialLinks = [
  ...
  {
    name: "WhatsApp",
    displayName: "Chat WhatsApp",
    subText: "+62 821-3810-2393",
    icon: MessageCircle,
    url: personalData.whatsapp,
    color: "#25D366",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Second Row - WhatsApp, GitHub & Email */}
            ...
            >
              ...
              <div className="relative flex items-center justify-center flex-shrink-0">
                ...
                <div className="relative p-2 rounded-lg">
                  <link.icon
                    className="w-4 h-4 sm:w-5 sm:h-5 transition-all duration-500 group-hover:scale-110"
              ...
              <div className="flex flex-col min-w-0 flex-grow">
                ...
                <span className="text-[11px] text-gray-400 truncate group-hover:text-gray-300 transition-colors duration-300">
                  {link.subText}
                </span>
              </div>

              <ExternalLink
                className="w-3.5 h-3.5 text-gray-500 group-hover:text-white ml-auto flex-shrink-0
                                       opacity-0 group-hover:opacity-100 transition-all duration-300
                                       transform group-hover:translate-x-0 -translate-x-1"
              />
